const mondai = [
    ...
    { number: 5, question: 'P183。テレビ放送の情報から影響をうける例として、「（　　　）を見て、投票先を決める。」がある。', answer: 'せんきょほうどう', image_name: '', answer2: '', etc_2: '', etc_3: '', etc_4: ''},
    { number: 6, question: 'P183。テレビ放送の情報から影響をうける例として、「（　　　）を見て、着る服や持ち物を決める。」がある。', answer: 'てんきよほう', image_name: '', answer2: '', etc_2: '', etc_3: '', etc_4: ''},
    { number: 7, question: 'P184。インターネットを使って、大勢の人と情報をやり取りすることができるSNS（LINE、フェイスブック、ティックトック）などのことを（　　　）メディアと呼んでいる。（カタカナ）', answer: 'ソーシャル', image_name: '', answer2: '', etc_2: '', etc_3: '', etc_4: ''},
