const mondai = [
    ...
    { number: 5, question: 'P118。（　　　）は、増水（ぞうすい）した川の水で洪水（こうずい）が起こらないように、一時的に水をたくわえる役わりも果たしている。（カタカナ）', answer: 'ダム', image_name: '5_rika_nagareru_mizu_29.png', answer2: '', etc_2: '', etc_3: '', etc_4: ''}
];